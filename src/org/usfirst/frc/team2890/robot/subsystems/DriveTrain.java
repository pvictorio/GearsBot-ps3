 ...
 * 
 * Changes
 * @version 11/12/2018 -pv Updated drive method to work with PS3 Dualshock controller.
 */
...
//		drive(-joy.getY(), -joy.getAxis(AxisType.kThrottle));
		drive(-joy.getY(), -joy.getRawAxis(4));	// 11/12/2018  This works with PS3 Controller!!!
	}
